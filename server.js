...
const User = mongoose.require("./controller/user_routes");
const Room = mongoose.require("./controller/room_routes");
const Reservation = mongoose.require("./controller/reservation_routes");
const Review = mongoose.require("./controller/review_routes");
